...
Anschließend wird $\beta$ für das nächste Viertel der Trainingsmenge schrittweise von 0 auf 1 erhöht und für das letzte viertel der Trainingsmenge auf 1 belassen um das VAE Model zu trainieren.
...
\textsc{BiMeanVAE} ist ein von \citep{coop} vorgestelltes Model bestehend aus einem bidirektionalem LSTM Encoder und einem LSTM Decoder. 
