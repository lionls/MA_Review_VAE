...
Hierbei wird $\Delta H_t$ schrittweise durch den Gradienten des Attribut-Modells bestimmt. Die Gradientenmatrix $\Delta H_t$ wird als eine Null-Matrix initialisiert.
...
\begin{table}[!h]
    ...
    $\quad$ Optimus          &  \underline{36.31} & \underline{7.17}& \underline{20.75}&\textbf{56.82} &  36.31   &   \underline{8.12}   & \underline{20.02}  &  56.71    \\ 
    ...
    $\quad$ Optimus            & \textbf{36.40}  & \textbf{7.78}&\textbf{20.99} &\underline{56.78} &   36.31  &  8.08    &  19.91 & 56.67  \\ 
    ...
    $\quad$ Optimus            & 35.03 ???  & 6.81& 19.44 &56.22 &   \underline{36.47}  &    \textbf{8.19}  & \textbf{20.21}  & \textbf{56.78}  \\ 
...
\begin{table}[h!]
    ...
    Optimus   & 0.1 & 0.5 & 1.0 & 1.5 & 3.0 & 0.3 & 3.5 & 1.0 & 0.5 & 3.5 \\
