...
\definecolor{BackgroundColor}{HTML}{FCF3CF}
\normalsize
...
\begin{figure}[!h]
    ...
    \framebox{
        ...
        \parbox{\columnwidth-4\fboxsep}{\textbf{Produkt:} NuGo Protein Bar, Vanilla Yogurt \\ \\
        \textbf{COOP+Attribute-Model:} \textcolor{HighlightColor}{easily} \ccolorbox[BackgroundColor]{orange \textcolor{HighlightColor}{easily} background} Apart from the obvious nutritional value, the taste was surprisingly better than I anticipated. Normally, if I find soy-based nutritional bars tend to have a chalky or tree-bark-like texture and taste. I dare say, the texture reminds me of a healthy-not-too-sweet 'Rice Krispy Treat'.\\ 
        \textbf{Scores:} R-1: ,R-2: ,R-L: ,MV: \\ \\
        \textbf{COOP:} Apart from the obvious nutritional value, the taste was surprisingly better than I anticipated. Normally, if I find soy-based nutritional bars tend to have a chalky or tree-bark-like texture and taste. I dare say, the texture reminds me of a healthy-not-too-sweet 'Rice Krispy Treat'.\\
        \textbf{Scores:} R-1: ,R-2: ,R-L: ,MV: }
    }
    \caption{Vergleich der Generierten Rezensionen zu einem Produkt des Amazon Datensatzes}
\end{figure}
