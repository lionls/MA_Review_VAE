...
\begin{table}[!h]
    ...
    $\quad$ \textsc{BiMeanVae}$^{\star}$ & 33.60   & 6.64    & 20.87 & 18.18& 32.87  & 6.93   & 19.89 & 22.41\\
...
Insbesondere der Rouge-1 Score übertrifft die \textit{SimpleAVG} Scores signifikant im Durchschnitt um 2,18\%.
Die größte Leistungssteigerung zwischen der COOP Kombinationsstrategie und \textit{SimpleAvg} erfährt BiMeanVAE.
