...
\begin{table}[!h]
    ...
    $\quad$ Optimus          &  \underline{36.31} & \underline{7.17}& \underline{20.75}&\textbf{56.82} &  35.47   &   6.20   & 19.20  &  56.60    \\ 
    ...
    $\quad$ Optimus            & \textbf{36.40}  & \textbf{7.78}&\textbf{20.99} &\underline{56.78} &   35.55  &  6.55    &  19.39 & 56.42  \\ 
...
\begin{table}[h!]
    ...
    Optimus   & 0.1 & 0.5 & 1.0 & 1.5 & 3.0 &  - &   &&   &  \\
    BiMeanVAE & 0.3 & 3.5 & 0.0 & 1.0 & 0.5 & 0.5 & 0.5 & 0.0 & 0.0 & 1.0 \\ \bottomrule
    \end{tabular}
